...
// end include: preamble.js
  ...
  function _Login(name, password) {
      window.login(UTF8ToString(name), UTF8ToString(password));
    }

  function _Register(name, password) {
      var nameParsed = UTF8ToString(name);
      var passwordParsed = UTF8ToString(password);
      window.alert(nameParsed);
      window.register(nameParsed, passwordParsed);
    }
